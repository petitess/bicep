...
module kvint 'kvint.bicep' = {
  ...
  params: {
    ...
    appserviceidentity: appitglueint.outputs.principalId
    operations: param.id.operations
    location: param.location
    param: param
  }
}
...
module appitglueint 'appitglueint.bicep' = {
  ...
  params: {
    ...
    KeyVaultUrl: '${param.itglueint.kvname}${environment().suffixes.keyvaultDns}'
    location: param.location
    env: env
  }
}
