...
resource secret01 'Microsoft.KeyVault/vaults/secrets@2023-07-01' = {
  name: 'secret01'
  parent: kv
  properties: {
    value: guid(kv.name)
...
resource secret02 'Microsoft.KeyVault/vaults/secrets@2023-07-01' = {
  name: 'sqlpass'
  parent: kv
  properties: {
    value: '12345678.abC'
...
resource secret03 'Microsoft.KeyVault/vaults/secrets@2023-07-01' = {
  name: 'dbw-token'
  parent: kv
  properties: {
    value: 'dapi5229022f765189a2fd25ded70e7b473e-2' //created in the databricks
  }
}
