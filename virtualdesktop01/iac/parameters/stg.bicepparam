      ...
      rules: [
        {
          ...
          properties: {
            ...
            sourcePortRange: '*'
            destinationAddressPrefix: '10.100.56.0/27'
        ...
        }
        {
          ...
          properties: {
            access: 'Allow'
            sourceAddressPrefix: '10.100.56.0/27'
            sourcePortRange: '*'
        ...
        }
        {
          ...
          properties: {
            access: 'Allow'
            sourceAddressPrefix: '10.100.56.0/24'
            sourcePortRange: '*'
