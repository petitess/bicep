...
resource linkschedule 'Microsoft.Resources/deploymentScripts@2020-10-01' = {
  name: 'linkschedule'
  location: location
  tags: tags
  kind: 'AzurePowerShell'
  ...
  properties: {
    ...
    timeout: 'PT10M'
    cleanupPreference: 'Always'
    scriptContent: config.environment.name == 'Production' ? loadTextContent('link-schedule-prod.ps1') : loadTextContent('link-schedule-test.ps1')
  }
}
