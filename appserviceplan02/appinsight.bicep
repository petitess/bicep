...
resource webtest 'Microsoft.Insights/webtests@2022-06-15' = [for webtest in webtests: if(false) {
...
resource alerts 'Microsoft.Insights/metricAlerts@2018-03-01' =[for (alert, i) in webtests: if(false) {
