...
param skus string = '2016-datacenter'

param scriptFileName string = 'InstallAD_CreateDomain.ps1'
var scriptLocation = 'https://raw.githubusercontent.com/petitess/powershell/main/InstallAD_CreateDomain.ps1'
