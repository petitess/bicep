...
resource rgsql 'Microsoft.Resources/resourceGroups@2021-04-01' ={
  location: param.location
  tags: param.tags
  name: 'rg-sqldb-${affix}-01'
}
...
module pe 'pe.bicep' = {
  ...
  params: {
    location: param.location
    name: 'pe-${affix}-01'
    privateLinkServiceId: sqldb.outputs.sqlsrvid
    subnetid: vnet01.outputs.pesubnetid
  }
}
