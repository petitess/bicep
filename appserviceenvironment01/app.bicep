...
resource hostNamedBindings 'Microsoft.Web/sites/hostNameBindings@2025-03-01' = if (!empty(customDomain) && !empty(customDomain)) {
...
resource hybridConnectionRelayy 'Microsoft.Web/sites/hybridConnectionNamespaces/relays@2025-03-01' = if (hybridConnectionRelay != null) {
  name: '${app.name}/${hybridConnectionRelay.relayName}/relay01'
  properties: hybridConnectionRelay
}

resource cred_pol_ftp 'Microsoft.Web/sites/basicPublishingCredentialsPolicies@2025-03-01' = {
  parent: app
  name: 'ftp'
  properties: {
...
resource cred_pol_scm 'Microsoft.Web/sites/basicPublishingCredentialsPolicies@2025-03-01' = {
  parent: app
  name: 'scm'
  properties: {
...
resource config_appset 'Microsoft.Web/sites/config@2025-03-01' = if (configAppsettings != null) {
  parent: app
  name: 'appsettings'
  properties: configAppsettings
}

resource config_appset_slot_conf_names 'Microsoft.Web/sites/config@2025-03-01' = if (configAppsettings != null) {
  parent: app
...
resource config_auth 'Microsoft.Web/sites/config@2025-03-01' = {
  parent: app
  name: 'authsettingsV2'
...
resource config_webb 'Microsoft.Web/sites/config@2025-03-01' = if (configWeb != null) {
  parent: app
  name: 'web'
...
resource app_SLOT 'Microsoft.Web/sites/slots@2025-03-01' = if (!empty(SLOT)) {
  name: SLOT.name
  parent: app
  location: location
  kind: kind
...
resource hostNamedBindingsSlots 'Microsoft.Web/sites/slots/hostNameBindings@2025-03-01' = if (!empty(SLOT) && !empty(SLOT.?customDomain)) {
...
resource cred_pol_ftp_SLOT 'Microsoft.Web/sites/slots/basicPublishingCredentialsPolicies@2025-03-01' = if (SLOT.?enableBasicAuthFtp != null) {
  parent: app_SLOT
  name: 'ftp'
  properties: {
...
resource cred_pol_scm_SLOT 'Microsoft.Web/sites/slots/basicPublishingCredentialsPolicies@2025-03-01' = if (SLOT.?enableBasicAuthScm != null) {
  parent: app_SLOT
  name: 'scm'
  properties: {
...
resource config_appset_SLOT 'Microsoft.Web/sites/slots/config@2025-03-01' = if (SLOT.?configAppsettings != null) {
  parent: app_SLOT
  name: 'appsettings'
  properties: SLOT.?configAppsettings
}

resource config_webb_SLOT 'Microsoft.Web/sites/slots/config@2025-03-01' = if (SLOT.?configWeb != null) {
  parent: app_SLOT
  name: 'web'
  properties: SLOT.?configWeb
}

resource config_auth_SLOT 'Microsoft.Web/sites/slots/config@2025-03-01' = if (SLOT != null) {
  parent: app_SLOT
  name: 'authsettingsV2'
...
resource pepR 'Microsoft.Network/privateEndpoints@2025-05-01' = [
