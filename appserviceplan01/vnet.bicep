...
resource nsg 'Microsoft.Network/networkSecurityGroups@2024-07-01' = [for subnet in subnets: if (contains(subnet, 'rules')) {
...
resource rt 'Microsoft.Network/routeTables@2024-07-01' = [for subnet in subnets: if (contains(subnet, 'routes')) {
  name: 'rt-${subnet.name}'
  location: location
  tags: tags
  properties: {
