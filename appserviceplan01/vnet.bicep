...
resource vnet 'Microsoft.Network/virtualNetworks@2021-03-01' = {
  ...
  properties: {
    ...
    subnets: [for (subnet, i) in subnets: {
      name: subnet.name
      properties: {
        delegations: subnet.properties.serverFarmsDelegation ? [
          {
            name: 'serverFarms'
              properties: {
...
output AppSubId string = vnet.properties.subnets[7].id
output AppSubName string = vnet.properties.subnets[7].name
