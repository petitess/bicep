    ...
    customers: [
      {
        name: 'onprem'
        tag: 'Watchguard'
        gatewayIpAddress: '123.123.123.1'
        localAddresses: [
          '10.112.0.0/16'
          '10.114.0.0/24'
          '10.113.0.0/24'
      ...
      }
      {
        name: 'ravlanda'
        tag: 'Rävlanda'
        gatewayIpAddress: '123.123.123.2'
        localAddresses: [
          '192.168.0.0/24'
          '192.168.35.0/24'
          '192.168.36.0/24'
      ...
      }
      {
        name: 'satila'
        tag: 'Sätila'
        gatewayIpAddress: '123.123.123.3'
        localAddresses: [
          '192.168.46.0/24'
          '192.168.47.0/24'
          '192.168.30.0/24'
      ...
      }
      {
        name: 'primapraktiken'
        tag: 'Primapraktiken'
        gatewayIpAddress: '123.123.123.4'
        localAddresses: [
          '10.201.110.0/24'
        ]
      }
      {
        name: 'marstrand'
        tag: 'Marstrand'
        gatewayIpAddress: '123.123.123.5'
        localAddresses: [
          '10.212.4.0/24'
        ]
        ipsecPolicies: [
    ...
    subnets: [
      ...
      }
      {
        ...
        securityRules: [
          ...
          {
            name: 'Allow_Outbound_Customers_Web'
            properties: {
              protocol: '*'
              sourcePortRange: '*'
              destinationPortRanges: [
          ...
          {
            name: 'Allow_Outbound_Customers_ICMP'
            properties: {
              protocol: 'ICMP'
              sourcePortRange: '*'
              destinationPortRange: '*'
          ...
          {
            name: 'Allow_Outbound_OnPrem_ICMP'
            properties: {
              protocol: 'ICMP'
              sourcePortRange: '*'
              destinationPortRange: '*'
              sourceAddressPrefix: '10.10.5.11'
              destinationAddressPrefix: '10.112.0.0/16'
              access: 'Allow'
              priority: 1250
              direction: 'Outbound'
            }
        ...
        securityRules: [
          ...
          }
          {
            ...
            properties: {
              ...
              sourcePortRange: '*'
              destinationPortRange: '443'
              sourceAddressPrefix: '10.10.6.0/24'
              destinationAddressPrefix: '10.10.3.0/24'
              access: 'Allow'
              priority: 900
              direction: 'Outbound'
