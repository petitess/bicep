...
resource lgw2 'Microsoft.Network/localNetworkGateways@2021-08-01' = {
  name: replace(lgwname,'1','2')
  tags: param.tags
  location: param.location
  properties: {
    localNetworkAddressSpace: param.lgw2.localNetworkAddressSpace
    gatewayIpAddress: param.lgw2.gatewayIpAddress
  }
}
...
resource con2 'Microsoft.Network/connections@2021-08-01' = {
  name: param.con2.name
  location: param.location
  properties: {
    virtualNetworkGateway1: {
      id: vgw.id
