...
resource heartbeat 'Microsoft.Insights/scheduledQueryRules@2022-06-15' = [for vm in virtualMachines: if(vm.VMalerts) {
...
resource heartbeat2 'Microsoft.Insights/scheduledQueryRules@2022-06-15' = {
