...
resource rsv 'Microsoft.RecoveryServices/vaults@2023-08-01' = {
  name: name
  location: location
  tags: tags
  sku: sku
...
resource defaultPolicy 'Microsoft.RecoveryServices/vaults/backupPolicies@2023-08-01' = {
  parent: rsv
  name: 'DefaultPolicy'
  properties: {
    instantRPDetails: {
...
resource PolicyFileServer 'Microsoft.RecoveryServices/vaults/backupPolicies@2023-08-01' = {
  parent: rsv
...
resource filesharePolicy 'Microsoft.RecoveryServices/vaults/backupPolicies@2023-08-01' = {
