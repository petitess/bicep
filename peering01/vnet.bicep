...
resource peering 'Microsoft.Network/virtualNetworks/virtualNetworkPeerings@2022-07-01' = [for p in peerings: {
  name: 'peer-${name}-${p.remotevnet}'
  parent: vnet
  properties: {
    remoteVirtualNetwork: {
      id: resourceId(p.remotevnetrg, 'Microsoft.Network/virtualNetworks', p.remotevnet)
    }
    ...
    remoteAddressSpace: p.remoteAddressSpace
  }
}]
