  ...
  dev: [
    ...
    }
    {
      ...
      securityRules: [
        ...
        {
          name: 'nsgsr-allow-func-inbound'
          properties: {
            access: 'Allow'
            sourceAddressPrefix: cidrSubnet(addressPrefixes[environment][0], 26, 2)
            sourcePortRange: '*'
            destinationAddressPrefix: '*'
    ...
    }
    {
      ...
      securityRules: [
        ...
        {
          name: 'nsgsr-allow-func-outbound'
          properties: {
            access: 'Allow'
            sourceAddressPrefix: '*'
            sourcePortRange: '*'
            destinationAddressPrefix: cidrSubnet(addressPrefixes[environment][0], 26, 1)
            destinationPortRanges: [
              '443'
              '445'
            ]
