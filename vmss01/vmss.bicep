...
resource ss 'Microsoft.Compute/virtualMachineScaleSets@2023-07-01' = {
  name: name
  location: location
  tags: tags
  sku: {
...
resource tools 'Microsoft.Compute/virtualMachineScaleSets/extensions@2023-07-01' = if (imageReference.publisher == 'canonical') {
...
resource powershell 'Microsoft.Compute/virtualMachineScaleSets/extensions@2023-07-01' = if (imageReference.publisher == 'microsoftwindowsserver') {
  name: 'InstallAgents'
  parent: ss
  properties: {
    autoUpgradeMinorVersion: true
