...
resource func 'Microsoft.Web/sites@2024-04-01' = {
  ...
  properties: {
    ...
    siteConfig: {
      ...
      minTlsVersion: '1.2'
      http20Enabled: true
      appSettings: union(funcAppSettings, appSettings)
...
resource appSettingsWeb 'Microsoft.Web/sites/config@2024-04-01' = {
  name: 'web'
  parent: func
  properties: {
...
resource funcSlot 'Microsoft.Web/sites/slots@2024-04-01' = if (!empty(slot)) {
...
resource pepR 'Microsoft.Network/privateEndpoints@2024-03-01' = [
...
resource dns 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2024-03-01' = [
