    ...
    subnets: [
      ...
      }
      {
        ...
        securityRules: [
          ...
          {
            name: 'Allow_Inbound_StorageAccount'
            properties: {
              protocol: '*'
              sourcePortRange: '*'
              destinationPortRange: '443'
              sourceAddressPrefix: '10.10.4.11/32'
          ...
          {
            name: 'Allow_Outbound_S2S_RDP'
            properties: {
              protocol: '*'
              sourcePortRange: '*'
              destinationPortRange: '3389'
              sourceAddressPrefix: '10.10.4.11/32'
              destinationAddressPrefix: '10.30.4.11/32'
              access: 'Allow'
              priority: 300
              direction: 'Outbound'
            }
          ...
          {
            name: 'Allow_Outbound_StorageAccount'
            properties: {
              protocol: '*'
              sourcePortRange: '*'
              destinationPortRange: '443'
              sourceAddressPrefix: '10.10.4.11'
              destinationAddressPrefix: '10.10.3.0/24'
              access: 'Allow'
              priority: 350
              direction: 'Outbound'
