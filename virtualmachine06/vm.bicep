...
resource workspaceExtension01 'Microsoft.Compute/virtualMachines/extensions@2022-03-01' = if(extensions) {
  name:  'MicrosoftMonitoringAgent01'
  parent: vm
  location: location
  tags: tags
  properties: {
    ...
    type: imageReference.publisher == 'canonical' ? 'OmsAgentForLinux' : 'MicrosoftMonitoringAgent'
    typeHandlerVersion: imageReference.publisher == 'canonical' ? '1.14' : '1.0'
    settings: {
