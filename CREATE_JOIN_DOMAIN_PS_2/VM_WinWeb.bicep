...
param domainFQDN string = 'b3care.test'
param domainJoinUserName string = 'sek'
param domainJoinUserPassword string = '12345678.abc'
//Create a new OU and place the path here
param ouPath string = 'OU=comp,DC=b3care,DC=test'
...
resource joindomain 'Microsoft.Compute/virtualMachines/extensions@2021-03-01' =  {
  name: 'joindomain'
  location: location
  parent: windowsVM
  properties: {
