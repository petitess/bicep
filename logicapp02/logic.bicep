        ...
        actions: {
          ...
          HTTP: {
            ...
            inputs: {
              ...
              body: {
                query: 'patchassessmentresources | where type == \'microsoft.compute/virtualmachines/patchassessmentresults\' | where subscriptionId == \'${subId}\' | where properties.availablePatchCountByClassification.security > 0 or properties.availablePatchCountByClassification.critical > 0 | extend security = properties.availablePatchCountByClassification.security, critical = properties.availablePatchCountByClassification.critical | project resourceGroup, security, critical'
              }
              headers: {
