...
param solutions ('VMInsights' | 'Security' | 'ServiceMap' | 'ChangeTracking' | 'SecurityInsights')[]
...
resource dataSources 'Microsoft.OperationalInsights/workspaces/dataSources@2023-09-01' = [
  for event in events: {
    parent: log
    name: event
    kind: 'WindowsEvent'
