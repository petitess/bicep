...
module vgwcon1 'vgwcon.bicep' = {
  ...
  params: {
    ...
    virtualNetworkGateway1id: '${subscription().id}/resourceGroups/${rginfra.name}/providers/Microsoft.Network/virtualNetworkGateways/vgw-${affix}-01'
    virtualNetworkGateway2id: '${subscription().id}/resourceGroups/${rginfra3.name}/providers/Microsoft.Network/virtualNetworkGateways/vgw-${affix}-03'
  }
}
...
module vgwcon3 'vgwcon.bicep' = {
  ...
  params: {
    ...
    sharedKey: '12345678abc!'
    virtualNetworkGateway1id: '${subscription().id}/resourceGroups/${rginfra3.name}/providers/Microsoft.Network/virtualNetworkGateways/vgw-${affix}-03'
    virtualNetworkGateway2id: '${subscription().id}/resourceGroups/${rginfra.name}/providers/Microsoft.Network/virtualNetworkGateways/vgw-${affix}-01'
  }
}
