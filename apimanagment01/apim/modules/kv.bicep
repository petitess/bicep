    ...
    privateDnsZoneConfigs: [
      {
        ...
        properties: {
          privateDnsZoneId: resourceId(pdnszRgName, 'Microsoft.Network/privateDnsZones', 'privatelink.vaultcore.azure.net')
        }
      }
    ]
  }
...
resource diag 'Microsoft.Insights/diagnosticSettings@2021-05-01-preview' = if(workspaceId != '') {
  name: 'diag-kv'
  scope: kv
  properties: {
