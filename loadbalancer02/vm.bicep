    ...
    ipConfigurations: [
      {
        ...
        properties: {
          ...
          loadBalancerBackendAddressPools: interface.loadBalancerBackendAddressPools ? [
            {
...
resource virtualMachine_IIS 'Microsoft.Compute/virtualMachines/extensions@2022-08-01' = if(DeployIIS) {
  name: 'IIS'
  location: location
  parent: vm
  properties: {
